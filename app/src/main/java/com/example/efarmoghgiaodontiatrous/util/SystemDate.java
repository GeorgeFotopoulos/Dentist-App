 ...
 * προκαθορισμένη ημερομηνία. Η δυνατότητα αυτή είναι ιδιαίτερη χρήσιμη
 * για την εκτέλεση αυτόματων ελέγχων.
 *
...
public class SystemDate {
     ...
     * Εάν αντί για προκαθορισμένης ημερομηνίας τεθεί {@code null} τότε
     * επιστρέφεται η πραγματική ημερομηνία του συστήματος.
     *
     * @param stubDate Η ημερομηνία η οποία θα επιστρέφεται ως ημερομηνία του συστήματος                 ή {@code null} για να επιστρέφει την πραγματική ημερομηνία
     */
    ...
    /**
     * Επιστρέφει την ημερομηνία του συστήματος ή μία προκαθορισμένη ημερομηνία
     * που έχει τεθεί από την {@link SystemDate#setStub}.
     *
